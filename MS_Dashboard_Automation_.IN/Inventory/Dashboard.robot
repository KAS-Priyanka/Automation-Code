...
5.Verify Revenue Units VS Inventory Card
    ...
    Select Dropdown Option And Verify  ${REVENUE_UNITS_VS_INVENTORY_DROPDOWN}   AT03_BLUE_C_FBA    ${REVENUE_UNITS_VS_INVENTORY_SHIMMER}     ${REVENUE_UNITS_VS_INVENTORY_CARD}     
...
6.Verify SKU WISE FBA Units Card
    ...
    Asc And Desc Toggle   ${SKU_WISE_FBA_UNITS_TOGGLE}   SKU wise FBA Units toogle click
...
7.Verify SKU WISE FBM Units Card
    ...
    Asc And Desc Toggle      ${SKU_WISE_FBM_UNITS_TOGGLE}      SKU wise FBM Units toogle click
...
8.Verify SKU Net Month Coverage
    ...
    Asc And Desc Toggle    ${SKU_NET_MONTH_COVERAGE_TOGGLE}     SKU Net Month Coverage toogle click
