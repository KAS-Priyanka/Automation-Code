...
2.Validate Sales Navigation,Open Coupon Performance and Verify MSC Intelligence
    [Documentation]    Validate navigation to Sales module, open Coupon Performance from sidebar,
...
4.Verify Coupon Performance Cards
...
7.Verify List Of Under Performing Coupons
...
8.Verify List Of Coupons Nearing Budget Limit
