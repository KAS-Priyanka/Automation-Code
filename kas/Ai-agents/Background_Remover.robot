...
5.Verify Invalid Image And Valid Image 
   [Documentation]    Upload invalid image and Upload valid image 
...
6.Select Size And Background Color
    [Documentation]    Provide Size, Select Background Color, and Generate Image
    Select Marketplace   ${MARKETPLACE_DROPDOWN}  Flipkart
